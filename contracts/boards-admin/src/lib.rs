...
impl BoardsAdmin {
    ...
    fn render_threshold_settings(env: &Env, viewer: &Option<Address>) -> Bytes {
        ...
        md = md
            ...
            .newline()
            .text("**Require Profile** (true/false):").newline()
            .input_with_value("require_profile", "true or false", if board_thresholds.require_profile { "true" } else { "false" })
            .newline()
        ...
        md = md
            ...
            .newline()
            .text("**Require Profile** (true/false):").newline()
            .input_with_value("require_profile", "true or false", if community_thresholds.require_profile { "true" } else { "false" })
            .newline()
            .text("**Per-User Limit** (0 = unlimited):").newline()
